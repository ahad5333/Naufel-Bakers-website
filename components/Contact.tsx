...
const Contact: React.FC = () => {
  ...
  const WHATSAPP_NUMBER = "917671073675";
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            <div className="bg-cream p-8 rounded-lg shadow-lg space-y-8">
              <div>
                ...
                <p className="mt-2 text-brown-light">
                  H NO 5-6-134/2/A, beside RELAINCE SMART POINT, Teachers Colony, Mahabubnagar, Telangana 509001, India
                </p>
              </div>
              <div>
          ...
          <div className="bg-cream p-8 rounded-lg shadow-lg">
            ...
            <form onSubmit={handleFormSubmit} className="space-y-6">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-brown-dark">
                  Full Name
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="phone" className="block text-sm font-medium text-brown-dark">
                  Phone Number
                </label>
                <input
                  type="tel"
              ...
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-brown-dark">
                  Message Here For Order:
                </label>
                <textarea
                  name="message"
                  id="message"
